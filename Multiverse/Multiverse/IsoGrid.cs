...
namespace Multiverse
{
    class IsoGrid
    {
        ...
        public IsoGrid(GraphicsDevice graphicsDevice, double gridAngle,int edgeLength, Vector2 gridSize)
        {
        ...
        public void Draw(SpriteBatch sbatch)
        {
            for (int i = 0; i < size.Y +1; i++)
            {
                ...
                sbatch.Draw(blank, line4.Item1 + new Vector2(0, 0), null, Microsoft.Xna.Framework.Color.Red, angle4, Vector2.Zero, new Vector2(length4, 1.0f), SpriteEffects.None, 0.89f);
